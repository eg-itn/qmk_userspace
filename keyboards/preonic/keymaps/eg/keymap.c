 ...
 * +------+------+------+------+------+------+------+------+------+------+------+------+
 * │ MO(2)│   A  │   S  │   D  │   F  │   G  │   H  │   J  │   K  │   L  │   ;  │   '  │
 * +------+------+------+------+------+------+------+------+------+------+------+------+
 * │ Shft │   Z  │   X  │   C  │   V  │   B  │   N  │   M  │   ,  │   .  │ SLSH │ Shft │
 * +------+------+------+------+------+------+------+------+------+------+------+------+
...
[_LAYER1] = LAYOUT_ortho_5x12(
    ...
    KC_TRNS, CTRLZ, CTRLX, CTRLC, CTRLV, KC_TRNS, KC_TRNS, KC_DEL, KC_END, KC_PGDN, ROMA, KC_TRNS,
...
[_LAYER2] = LAYOUT_ortho_5x12(
    KC_TRNS, MS_BTN1, MS_BTN3, MS_BTN2, KC_TRNS, KC_TRNS, KC_TRNS, KC_NUM, KC_PSLS, KC_PAST, KC_PMNS, KC_PPLS,
    KC_ESC, MS_WHLL, MS_UP, MS_WHLR, MS_WHLU, KC_TRNS, KC_TRNS, KC_P7, KC_P8, KC_P9, KC_PPLS, KC_CAPS,
    ...
    KC_TRNS, KC_TRNS, MS_ACL0, MS_ACL0, KC_TRNS, MS_ACL2, KC_TRNS, KC_P0, KC_P0, KC_PDOT, KC_PENT, KC_TRNS
    ),
...
[_LAYER4] = LAYOUT_ortho_5x12(
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RM_TOGG, KC_BRID, KC_BRIU,
